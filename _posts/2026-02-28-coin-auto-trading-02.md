...
[1편 보러가기](https://mhs442.github.io/2026-02-24/coin-auto-trading-01)
...
그래서! 가장 만만한 **ERD Cloud**를 이용해서 그려보자. 그럼 논리적 설계를 먼저 해보자. (**VSCode**의 플러그인으로 ERD Editor를 사용하면 버그가 없다는 소식에 다시 ERD Editor를 쓰기로 결정했다.)
